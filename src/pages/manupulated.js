...
export function runManipulation(
    p,
    face,
    videoSize,
    progress = 1
    ...
    const eyePoints =
        mirroredPoints.map(
            (pt, i) => ({
                ...
                x: p.lerp(
                    pt.x,
                    manipulatedEyePoints[i].x,
                    progress
                ),

                y: p.lerp(
                    pt.y,
                    manipulatedEyePoints[i].y,
                    progress
                )
    ...
    const manipulatedMouthPoints =
        manipulatedMouthResult.points;
    ...
    const mouthMode =
        manipulatedMouthResult.mode;

    const openAmount =
        manipulatedMouthResult.openAmount;
